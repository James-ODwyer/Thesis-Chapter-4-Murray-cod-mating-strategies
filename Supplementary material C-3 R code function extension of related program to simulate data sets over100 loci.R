# supplementary material C-3 R code function extension of related program to simulate data sets >100 loci
...
# analysed using FORTRAN underlying calls from the package
